...
export const config = {
  ...
  lanHost: process.env.PMCP_LAN_HOST ?? "127.0.0.1",
  ...
  allowedHosts: list("PMCP_ALLOWED_HOSTS", ["127.0.0.1", "localhost"]),
  allowedOrigins: list("PMCP_ALLOWED_ORIGINS", ["localhost", "127.0.0.1"]),
  ...
  pveTlsServername: process.env.PMCP_PVE_TLS_SERVERNAME ?? "localhost",
